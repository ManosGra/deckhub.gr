...
if (isset($_POST['add_category_btn'])) {
    ...
    $cate_query = "INSERT INTO product_categories (category_name, slug, category_description, meta_title, meta_description, meta_keywords, status, popular, category_image) VALUES ('$name', '$slug','$description','$meta_title','$meta_description','$meta_keywords','$status','$popular','$filename')";
    ...
    if ($cate_query_run) {
        ...
        echo "Error: " . mysqli_error($conn);  // This will show the error message
        exit();
    }
