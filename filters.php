<section id="filters" class="mt-5 pt-3 filters">
<div class="mb-5">
    <h5 class="mb-4 fw-bold text-primary">Διαθεσιμότητα</h5>
    <input type="checkbox" class="border border-dark form-check-input me-2" id="exampleCheck1" checked disabled>
    <label class="form-check-label fw-bold">Όλα τα προϊόντα</label><br>
</div>

    <h5 class="mb-3 fw-bold text-primary">Υποκατηγορία</h5>
    <?php
    ...
    if (!$products || mysqli_num_rows($products) == 0) {
        ...
        foreach ($titles as $title) {
            ...
            echo '<input type="checkbox" class="border border-dark form-check-input" id="filter_' . htmlspecialchars($title) . '" onchange="filterProducts()">';
